...
- TypeScript/Vitest: 730 tests passing.
...
| EP-08 VAD/STT correction | Partial | 65% | VAD, phrase matcher, rolling STT window/backpressure scaffold, correction evaluator, STT disable no-op, and position JSONL logging exist; SyncEngine accepts correction events | Whisper.cpp native addon/model download remains the main missing platform-specific dependency |
